        ...
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl px-4 py-1.5 leading-8">
          ...
          <div className="flex items-center space-x-6 rtl:space-x-reverse">
            <div className="flex items-center text-primary-blue">
              ...
              >
                <span className="flex items-center ml-2 line-clamp-1 transition duration-700 ease-in-out hover:text-[#25D366]">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  ...
                  <span className="line-clamp-1 text-ellipsis w-40 md:w-full">
